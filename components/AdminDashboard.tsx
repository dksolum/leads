...
const OBJECTIONS_MAPPING: Record<string, { acolher: string, reenquadrar: string, solucionar1: string, solucionar2: string }> = {
    ...
    'Tenho medo/receio': {
        ...
        solucionar1: 'Se você pensar em qualquer decisão que realmente mudou a sua vida, todas elas foram acompanhadas de algum nível de medo, não é mesmo? Eu quero que você se sinta seguro ao se juntar à nós, por isso ofereço uma garantia: se por algum motivo você não alcançar um retorno mínimo do seu investimento, eu vou trabalhar de graça até você ter retorno sobre o seu investimento. Fica bom para você assim? / SE SIM: Você prefere parcelado ou à vista?',
        solucionar2: '...'
    },
    'Não é prioridade agora': {
        ...
        solucionar1: 'SE ENTENDER QUE É PRIORIDADE: Então, já está resolvido. Você quer mudanças e a gente vai começar agora. Você prefere o pagamento parcelado ou à vista?',
    ...
    'Não tomo decisão na hora': {
        ...
        solucionar1: 'SE NÃO: Combinado, então quanto tempo precisa para tomar essa decisão? [PUXAR PARA MENOS E NÃO DEIXAR DORMIR] / SE PARA +24h: NOME, infelizmente não consigo abir até [DATA DO CLIENTE], porque seria injusto com quem apresentei uma oferta diferenciada e a pessoa tomou a decisão antes. Conseguimos combinar até hoje às [HORÁRIO GANCHO]? SE NÃO: E até hoje [HORÁRIO LIMITE NO DIA]? SE NÃO: Então, amanhã as 12:00, pode ser? / SE SIM: Combinado, então entrarei em contato amanhã às 12:00 para sua confirmação. Pode ser?',
        solucionar2: 'Existe alguma informação ou detalhe adicional que você precisa para conseguir tomar essa decisão hoje comigo agora?'
    },
    ...
    'Preciso falar com minha esposa/sócio': {
        acolher: 'NOME, para validar se eu compreendi corretamente: sua esposa/sócio é uma pessoa importante para as decisões de mudança na sua vida. Certo? / Se ela falra "NÃO", você desiste de inversir em você?',
        reenquadrar: 'SE NÃO: Bom, então você tem tudo o que precisa: que é a sua decisão de melhorar de vida e entregar o melhor de você para ela. Vamos avançar então. Você prefere marcar a reunião para um horário da manhã ou da tarde?',
        solucionar1: 'SE SIM: Perfeito. Para confirmar: se não dependesse da sua esposa, mas apenas de você, você fecharia, correto? / SE SIM: Certo. Sua esposa/sócio é do tipo de pessoa que não apoiaria uma decisão para cuidar da sua saúde e qualidade de vida?',
        solucionar2: 'SE NÃO: Bom, então você tem tudo o que precisa: que é a sua decisão de melhorar de vida e entregar o melhor de você para ela. Vamos avançar então. Você prefere marcar a reunião para um horário da manhã ou da tarde? / SE SIM: Então, o que você acha de nós 3 conversarmos? / SE SIM: Eu posso te enviar um áudio, explicando tudo o que conversamos aqui para facilitar para você não ter que ficar lembrando de tudo. Aí você e ela/ele escutam juntos e podem tomar a decisão. Pode ser? / SE SIM: Conseguimos combinar de você me retornar até hoje às [HORÁRIO GANCHO]? SE NÃO: E até hoje [HORÁRIO LIMITE NO DIA]? SE NÃO: Então, amanhã as 12:00, pode ser? / SE SIM: Combinado, então entrarei em contato amanhã às 12:00 para a confirmação de vocês. Pode ser? '
    }
};
